 ...
 * @param {number} wallet_id
 */
export function frost_destroy_wallet(wallet_id) {
    wasm.frost_destroy_wallet(wallet_id);
}
 ...
 * @returns {number}
 */
export function frost_get_num_participants(wallet_id) {
    const ret = wasm.frost_get_num_participants(wallet_id);
    return ret >>> 0;
}
 ...
 * @returns {Uint16Array}
 */
export function frost_get_participant_ids(wallet_id) {
    const ret = wasm.frost_get_participant_ids(wallet_id);
 ...
 * @returns {boolean}
 */
export function frost_has_participant(wallet_id, participant_id) {
    const ret = wasm.frost_has_participant(wallet_id, participant_id);
    return ret !== 0;
}
